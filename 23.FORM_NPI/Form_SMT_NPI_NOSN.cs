...
namespace FORM
{
	...
	/// </summary>
	public class Form_SMT_NPI_NOSN : System.Windows.Forms.Form
    {
        ...
        public Form_SMT_NPI_NOSN(string line_cd)
        {
            //
            // Windows Form µðÀÚÀÌ³Ê Áö¿ø¿¡ ÇÊ¿äÇÕ´Ï´Ù.
            //
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form_SMT_NPI_NOSN));
            ...
            this.cmdBACK.Click += new System.EventHandler(this.button2_Click);
            // 
            // lblDate
            // 
            ...
            this.lblDate.Location = new System.Drawing.Point(1635, 0);
            ...
            this.lblTitle.Size = new System.Drawing.Size(1912, 109);
            ...
            this.fgrid_main.Size = new System.Drawing.Size(1896, 413);
            ...
            this.ptb4.Location = new System.Drawing.Point(1218, 486);
            this.ptb4.Name = "ptb4";
            ...
            this.ptb3.Location = new System.Drawing.Point(1218, 369);
            this.ptb3.Name = "ptb3";
            ...
            this.ptb2.Location = new System.Drawing.Point(1217, 239);
            this.ptb2.Name = "ptb2";
            ...
            this.ptb1.Location = new System.Drawing.Point(1218, 114);
            this.ptb1.Name = "ptb1";
            ...
            this.axfpSpread3.Location = new System.Drawing.Point(1298, 101);
            ...
            this.axfpSpread3.Size = new System.Drawing.Size(599, 394);
            ...
            this.axfpSpread2.Size = new System.Drawing.Size(1212, 394);
            ...
            this.Name = "Form_SMT_NPI_NOSN";
            this.Text = "Form_SMT_NPI_NOSN";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.Form_NPI_MR_Man_Inquiry_Load);
            this.VisibleChanged += new System.EventHandler(this.Form_SMT_NPI_NOSN_VisibleChanged);
        ...
        private void Form_NPI_MR_Man_Inquiry_Load(object sender, System.EventArgs e)
		{
           ...
           // Lang = ComVar.Var._strValue3;
            switch (ComVar.Var._strValue1)
            {
                ...
                default:
                    if (ComVar.Var._strValue1 == null) sLine_CD = "";
                    else sLine_CD = ComVar.Var._strValue1;//.Substring(1, 2);
                    break;
            }
            
             
          //  string Caption = "New Product Introduction";
            //switch (Lang)
            //{
            //    case "Vi":
            //        //Lang = "Vn";
            //        lblTitle.Text = "Theo dõi mã hàng mới";
            //        break;
            //    default:                   
            //        lblTitle.Text = "New Product Introduction";
            //        break;
            //}
                    ...
                    for (i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        if (dt.Rows[i]["TAIL_CD"].ToString() != "01")
                        {
                            ...
                            if (dt.Rows[i]["TAIL_CD"].ToString() == "04")
                            {
                                ...
                                if (dt.Rows[i]["VALUE3"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE3"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 5;
                                    if (dRate < 90)
                                    {
                                ...
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE4"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 6;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE5"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE5"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 7;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE6"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE6"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 8;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE7"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE7"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 9;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE8"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE8"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 10;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE9"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE9"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 11;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE10"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE10"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 12;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE11"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE11"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 13;
                                    if (dRate < 90)
                                    {
                                ...
                                if (dt.Rows[i]["VALUE12"].ToString().Trim() != "")
                                {
                                    double dRate = 0;
                                    dRate = Convert.ToDouble(dt.Rows[i]["VALUE12"].ToString().Trim());
                                    axfpSpread3.Row = iRowIndex + 1;
                                    axfpSpread3.Col = 14;
                                    if (dRate < 90)
                                    {
                        ...
                        else
                        {
                            ...
                            axfpSpread3.SetText(3, iRowIndex + 1, "D+1");
                            axfpSpread3.SetText(4, iRowIndex + 1, "D+2");
        ...
        private void Form_SMT_NPI_NOSN_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                //this.TopMost = true;

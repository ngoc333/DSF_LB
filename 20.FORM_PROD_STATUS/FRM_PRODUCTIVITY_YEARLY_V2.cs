...
namespace FORM
{
    public partial class FRM_PRODUCTIVITY_YEARLY_V2 : Form
    {
        public FRM_PRODUCTIVITY_YEARLY_V2()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_YEARLY_SELECT(string ARG_TYPE, string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_LONGTHANH.SMT_PRODUCTIVITY_YEARLY_SELECT";

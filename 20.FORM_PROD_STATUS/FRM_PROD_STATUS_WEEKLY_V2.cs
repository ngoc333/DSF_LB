...
namespace FORM
{
    public partial class FRM_PROD_STATUS_WEEKLY_V2 : Form
    {
        public FRM_PROD_STATUS_WEEKLY_V2()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_WEEKLY_SELECT(string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_LONGTHANH.SMT_PROD_WEEKLY_SELECT";
        ...
        {
            lblTitleProd.Text = "Weekly Assembly Production Average: 0%";
            ...
            if (arg_dt != null && arg_dt.Rows.Count > 0)
            {
                try
                {
                    ...
                    arcScale.EasingFunction = new BackEase();
                    double num = Convert.ToDouble(dt.Rows[0]["RATE"]);
                    ...
                    lblTitleProd.Text = "Weekly Stitching Production Average: " + num.ToString() + "%";
                }
                catch
                { }
            }
        ...
        private void BindingChart()
        {
            ...
            //InitChart("UPS1", dt, chartUPS1); InitChart("UPS2", dt, chartUPS2); InitChart("UPS3", dt, chartUPS3);
            InitDataChart("UPC", dt, chartUPC);
            InitDataChart("UPS1", dt, chartUPS1); InitDataChart("UPS2", dt, chartUPS2); InitDataChart("UPS3", dt, chartUPS3);
            ...
            if (this.Visible)
            {
               ...
               // line = "001"; mline = "001";
                ...
                switch (lang)
                {
                    case "Vi":
                        lang = "Vi";
                        lbltitle.Text = "Sản xuất trong tuần";
                        break;
                    default:

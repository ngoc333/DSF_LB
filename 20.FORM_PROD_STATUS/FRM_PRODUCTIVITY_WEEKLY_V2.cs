...
namespace FORM
{
    public partial class FRM_PRODUCTIVITY_WEEKLY_V2 : Form
    {
        public FRM_PRODUCTIVITY_WEEKLY_V2()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_WEEKLY_SELECT(string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_LONGTHANH.SMT_PRODUCTIVITY_WEEKLY_SELECT";

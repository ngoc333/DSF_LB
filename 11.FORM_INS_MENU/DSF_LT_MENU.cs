...
namespace FORM
{
    public partial class DSF_LT_MENU : Form
    {
         ...
         private DataTable SEL_PROD_MDI(string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_LT.SP_SMT_PROD_MDI";
        ...
        private DataTable dtPUPLayout()
        {
            ...
            {
                dt.Rows.Add("001", "000", "Nos 1\n(1 - 2- 3)", "0", "0");
                dt.Rows.Add("003", "000", "Nos 2\n(4 - 5 - 6)", "0", "1");
                dt.Rows.Add("002", "000", "Nos 3\n(7 - 8 - 9)", "0", "2");
                dt.Rows.Add("004", "000", "Nos 4\n(10 - 11 - 12)", "1", "0");
                dt.Rows.Add("005", "000", "Nos 5\n(13 - 14 - 15)", "1", "1");
                dt.Rows.Add("006", "000", "Nos 6\n(16 - 17 - 18)", "1", "2");
            }
            else if (ComVar.Var._strValue1 == "099")
            {
                dt.Rows.Add("099","000", "Nos N1\n(1 - 2)", "0", "0");
                dt.Rows.Add("099", "002", "Nos N2\n(3 - 4)", "0", "1");
                dt.Rows.Add("099", "003", "Nos N3\n(5 - 6)", "0", "2");
                dt.Rows.Add("099", "004", "Nos N4\n(7 - 8)", "0", "3");
                dt.Rows.Add("099", "005", "Nos N5\n(9 - 10)", "1", "0");
                dt.Rows.Add("099", "006", "Nos N6\n(11 - 12)", "1", "1");
                dt.Rows.Add("099", "007", "Nos N7\n(13 - 14)", "1", "2");
                dt.Rows.Add("099", "008", "Nos N8\n(15 - 16)", "1", "3");
            }  
            return dt;
        }
        ...
        /// </summary>
        #region Button Factory 1
        private void cmd_Nos1_MouseHover(object sender, EventArgs e)
        {
            cmd_Fac1.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Transparent;
            cmd_Fac1.BackgroundImage = Image.FromFile(Application.StartupPath + @"\IMG\fac_1.PNG");

        }
        private void cmd_Nos1_Click(object sender, EventArgs e)
        {
            cmd_Fac1.FlatAppearance.MouseOverBackColor = System.Drawing.Color.DarkKhaki;
        }
        ...
        #endregion Button Factory 1

        /// <summary>
        /// button NOS N ở màn hình ban đầu khi load form
        /// </summary>
        #region Button Nos N
        private void cmd_NosN_MouseHover(object sender, EventArgs e)
        {
            cmd_NosN.FlatAppearance.MouseOverBackColor = System.Drawing.Color.Transparent;
            cmd_NosN.BackgroundImage = Image.FromFile(Application.StartupPath + @"\IMG\nos_n1.png");
        }
        private void cmd_NosN_MouseClick(object sender, EventArgs e)
        {
            cmd_NosN.FlatAppearance.MouseOverBackColor = System.Drawing.Color.DarkKhaki;
        }
        ...
        private void selectNos()
        {
         ...
         //   lang = ComVar.Var._strValue3;
            if (ComVar.Var._strValue1 == "099")
            {
                ...
                btn_WS3.Visible = true;
                btn_WS2.Visible = true;
                btnLang.Visible = true;
                btnBack.Visible = false;
            }
            else if (ComVar.Var._strValue1 == "000")
            {
                tblMain2.Visible = false;
                tblMain1.Visible = false;
        ...
        private void getDataUC()
        {

            //if (UC_MENU1.lblRate_Qty.InvokeRequired)
            //{
            //    UC_MENU1.lblRate_Qty.BeginInvoke((MethodInvoker)delegate() { UC_MENU1.lblRate_Qty.Text = "1324"; });
            //}
            //else
            //{
            //    this.lblCounter.Text = this.index.ToString(); ;
            //}
            //dtOSD = Db.SEL_OSD_DATA("Q");
            //dtPROD = Db.SEL_OS_PRODUCTION_DATA("Q");
            //dtINV = Db.SEL_OS_INV_DATA("Q");
            //dtAbsent = Db.SEL_OS_ABSENT_DATA("Q");
            //dtPOD = Db.SEL_OS_POD_DATA("Q");
        }
...
//=====================================================================================================================
        ...
        {
            //System.Diagnostics.Process result = System.Diagnostics.Process.GetProcessesByName("EMD").FirstOrDefault();
        ...
        private void cmd_Fac1_MouseClick(object sender, MouseEventArgs e)
        {

          
        }

        private void cmd_NosN_MouseClick(object sender, MouseEventArgs e)
        {
            
        }

        private void cmd_Fac1_MouseLeave(object sender, EventArgs e)
        {
            cmd_Fac1.BackgroundImage = Image.FromFile(Application.StartupPath + @"\IMG\img_F1.png");
           
        }

        private void cmd_NosN_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void down_img(string Filename)
        {

            try
            {
                if (!File.Exists(Application.StartupPath + @"\IMG\" + Filename))
                {
                    File.Copy(@"\\172.30.106.187\Share\" + Filename, Application.StartupPath + @"\IMG\" + Filename);
                }
            }
            catch
            { }
        ...
        public void down(string Filename)
        {
            try
            {
                ...
                {
                    File.Copy(@"\\172.30.106.187\Share\" + Filename, Application.StartupPath + @"\" + Filename);
                }
                else
                {
                    FileInfo fi = new System.IO.FileInfo(Application.StartupPath + @"\" + Filename);
                    FileInfo fiSV = new System.IO.FileInfo(@"\\172.30.106.187\Share\" + Filename);
                    DateTime modification = fi.LastWriteTime;
                    DateTime modificationSV = fiSV.LastWriteTime;

                    if (modificationSV > modification)
                    {
                        File.Copy(@"\\172.30.106.187\Share\" + Filename, Application.StartupPath + @"\" + Filename, true);
                    }
                }
            }
            catch
